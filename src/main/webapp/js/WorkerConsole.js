...
if (this.console && this.console.info) {
	...
	this.Worker = function Worker(url) {
		...
		var w = new _Worker("js/WorkerConsole.js#" + url);
		...
		channel.port1.onmessage = function(e) {
			...
			console.info.apply(console, args); // Pass the args to the real log
		}
	...
	self.onmessage = function(e) {
		if (e.data === "console") {
			...
			self.console = { 
				...
				log: function() {        // Define console.log()
				...
				info: function() {        // Define console.log()
					// Copy the arguments into a real array
					var args = Array.prototype.slice.call(arguments);
					// Send the arguments as a message, over our side channel
					console._port.postMessage(args);
				},
				warn: function() {        // Define console.log()
					// Copy the arguments into a real array
					var args = Array.prototype.slice.call(arguments);
					// Send the arguments as a message, over our side channel
					console._port.postMessage(args);
				},
				error: function() {        // Define console.log()
					// Copy the arguments into a real array
					var args = Array.prototype.slice.call(arguments);
					// Send the arguments as a message, over our side channel
					console._port.postMessage(args);
				},
				debug: function() {        // Define console.log()
					// Copy the arguments into a real array
					var args = Array.prototype.slice.call(arguments);
					// Send the arguments as a message, over our side channel
					console._port.postMessage(args);
